# Taskpack 10 — Selected Inverse Entries and Phase D Interface — Cascade Instructions
...
4. Run the verification rules in `phase_C_task10_verification_rules.md`.
5. Write artefacts to the run root.
6. Write the report using `phaseC_TASK10_REPORT_TEMPLATE.md`.
...
Conform to:
- `CAS-C_TASK10_SPEC.md` for VERIFIED artefacts
- `PROV-C_TASK10_SPEC.md` for any unverified candidates
