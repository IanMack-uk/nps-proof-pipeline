# Taskpack 8 — Neumann-Series Inversion Bounds — Cascade Instructions
...
- `PhaseC_TASK8_NEUMANN_SERIES_BOUNDS_REPORT.md`
...
4. Run the verification rules in `phase_C_task8_verification_rules.md`.
5. Write artefacts to the run root.
6. Write the report using `phaseC_TASK8_REPORT_TEMPLATE.md`.
...
Conform to:
- `CAS-C_TASK8_SPEC.md` for VERIFIED artefacts
- `PROV-C_TASK8_SPEC.md` for any unverified candidates
