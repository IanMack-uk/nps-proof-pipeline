# Task 8 Upstream Evidence Map — Neumann-Series Inversion Bounds

This file specifies what counts as **VERIFIED** evidence for Task 8.
...
For each check id in Task 8, record:
