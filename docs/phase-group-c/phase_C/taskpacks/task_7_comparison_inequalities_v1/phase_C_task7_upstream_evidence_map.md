# Task 7 Upstream Evidence Map — Comparison Inequalities and Z-Matrix Sign Pattern

This file specifies what counts as **VERIFIED** evidence for Task 7.
...
For each check id in Task 7, record:
