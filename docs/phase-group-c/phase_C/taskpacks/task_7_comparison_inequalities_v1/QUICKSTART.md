# Taskpack 7 — Comparison Inequalities and Z-Matrix Sign Pattern (Quickstart)

## Purpose

Certify the sign pattern and comparison preconditions needed for inverse-sign conclusions (e.g., Z-matrix: off-diagonals ≤ 0), and record any comparison inequalities used.
...
- `phaseC_TASK7_REPORT_TEMPLATE.md`
- `phase_C_task7_verification_rules.md`
- `phase_C_task7_upstream_evidence_map.md`
...
- This task is typically paired with Task 6 (dominance). Together they enable M-matrix conclusions.
