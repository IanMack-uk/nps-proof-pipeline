# Task 5 Upstream Evidence Map — Locality and Sparsity Support Bounds

This file specifies what counts as **VERIFIED** evidence for Task 5.
...
For each check id in Task 5, record:
