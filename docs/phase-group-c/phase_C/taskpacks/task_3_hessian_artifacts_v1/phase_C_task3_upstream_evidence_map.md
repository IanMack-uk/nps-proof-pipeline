# Task 3 Upstream Evidence Map — Hessian Computation Artefacts

This file specifies what counts as **VERIFIED** evidence for Task 3.
...
For each check id in Task 3, record:
