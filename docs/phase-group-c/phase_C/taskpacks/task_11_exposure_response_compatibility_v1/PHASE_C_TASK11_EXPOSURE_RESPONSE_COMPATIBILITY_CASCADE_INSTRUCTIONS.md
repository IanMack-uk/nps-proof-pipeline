# Taskpack 11 — Exposure–Response Compatibility and Scaling — Cascade Instructions
...
4. Run the verification rules in `phase_C_task11_verification_rules.md`.
5. Write artefacts to the run root.
6. Write the report using `phaseC_TASK11_REPORT_TEMPLATE.md`.
...
Conform to:
- `CAS-C_TASK11_SPEC.md` for VERIFIED artefacts
- `PROV-C_TASK11_SPEC.md` for any unverified candidates
