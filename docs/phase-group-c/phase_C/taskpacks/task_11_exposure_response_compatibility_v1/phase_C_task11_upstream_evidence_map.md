# Task 11 Upstream Evidence Map — Exposure–Response Compatibility and Scaling

This file specifies what counts as **VERIFIED** evidence for Task 11.
...
For each check id in Task 11, record:
