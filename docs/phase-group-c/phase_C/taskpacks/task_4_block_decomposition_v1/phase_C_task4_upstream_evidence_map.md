# Task 4 Upstream Evidence Map — Structural Block Decomposition

This file specifies what counts as **VERIFIED** evidence for Task 4.
...
For each check id in Task 4, record:
