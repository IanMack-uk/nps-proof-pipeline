# Task 6 Upstream Evidence Map — Diagonal Dominance Certification

This file specifies what counts as **VERIFIED** evidence for Task 6.
...
For each check id in Task 6, record:
