# Taskpack 6 — Diagonal Dominance Certification (Quickstart)

## Purpose

Certify strict diagonal dominance (or block diagonal dominance) for the relevant coupling matrix (typically `C := -H`) or for specified Hessian blocks.
...
- `phaseC_TASK6_REPORT_TEMPLATE.md`
- `phase_C_task6_verification_rules.md`
- `phase_C_task6_upstream_evidence_map.md`
...
- Record explicit dominance margins `δ`; Phase D typically requires **strict** inequalities.
