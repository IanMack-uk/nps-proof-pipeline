# Task 12 Upstream Evidence Map — CAS-C Integrity and Minimality (Drop-Test)

This file specifies what counts as **VERIFIED** evidence for Task 12.
...
For each check id in Task 12, record:
