# Task 9 Upstream Evidence Map — M-Matrix Criteria and Inverse Positivity

This file specifies what counts as **VERIFIED** evidence for Task 9.
...
For each check id in Task 9, record:
