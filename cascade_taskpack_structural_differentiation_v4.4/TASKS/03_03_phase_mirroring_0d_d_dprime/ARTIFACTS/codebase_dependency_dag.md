...
- `nps.phase_d` -> `nps.phases.phase_0d`
- `nps.phase_d` -> `nps.phases.phase_c`
- `nps.phase_d` -> `nps.phases.phase_d`
...
- `nps.phases.phase_0d` -> `nps.kernel`
- `nps.phases.phase_0d` -> `nps.validation`
...
- `nps.phases.phase_d` -> `nps.kernel`
- `nps.phases.phase_d` -> `nps.phases.phase_0d`
- `nps.phases.phase_d` -> `nps.phases.phase_c`
- `nps.phases.phase_d` -> `nps.validation`
- `nps.phases.phase_d_prime` -> `nps.validation`
...
flowchart TD
  ...
  nps_phases_phase_0d[nps.phases.phase_0d]
  ...
  nps_phases_phase_d[nps.phases.phase_d]
  nps_phases_phase_d_prime[nps.phases.phase_d_prime]
  ...
  nps_phase_d --> nps_phases_phase_0d
  nps_phase_d --> nps_phases_phase_c
  nps_phase_d --> nps_phases_phase_d
  ...
  nps_phases_phase_0d --> nps_kernel
  nps_phases_phase_0d --> nps_validation
  ...
  nps_phases_phase_d --> nps_kernel
  nps_phases_phase_d --> nps_phases_phase_0d
  nps_phases_phase_d --> nps_phases_phase_c
  nps_phases_phase_d --> nps_validation
  nps_phases_phase_d_prime --> nps_validation
